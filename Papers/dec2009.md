Ah, I see exactly what happened! I apologize for the mistake. 

In Markdown, if you put a line like `---` directly underneath text, it accidentally turns that text into a **giant Heading** (it's called a Setext heading). That is why Option (D) was looking huge and bold in your preview! 

To fix this, there **must be an empty line** between the last option and the horizontal line. I have also added invisible "hard breaks" (two spaces) at the end of options A, B, and C so they stack neatly without gaps, exactly like your Google Doc screenshot.

Here is the perfect, bug-free format:
